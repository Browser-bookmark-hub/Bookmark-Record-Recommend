...
- `history_html/history.css`：补齐 folder-tree 树节点/连接线/图标样式，修复文件夹树线条与图标对齐
- `history_html/history.css`：补齐 add-folder-tree-item 与 Markdown callout/wikilink 样式，修复选择树/说明渲染的缺失样式
...
本轮修复：
- history_html/browsing_history_calendar.js：增加 i18n 容错，避免读取 zh_CN 时 undefined 报错
- history_html/bookmark_calendar.js：同上
- history_html/history.js：补齐 i18n.searchNoResults；setupRealtimeMessageListener 增加 undefined 容错
...
---
## SPLIT-AUDIT-ADDENDUM-20260202_123812
时间：2026-02-02 12:38

修复：
- 书签记录（日历/点击记录）顶部栏结构还原为对照组（按钮组与面包屑同一行容器），避免排版偏移
  - 文件：/Users/kk/Downloads/kk/record & recommend/Bookmark-Record-Recommend/history_html/history.html

保留：
- i18n 容错与导出目录命名（record 专用）
  - history_html/bookmark_calendar.js
  - history_html/browsing_history_calendar.js

复扫：
- 输出目录：/Users/kk/Downloads/kk/_compare_snapshots/_reports/rescan_20260202_123812
- 汇总：/Users/kk/Downloads/kk/_compare_snapshots/_reports/rescan_20260202_123812/RESCAN_COMPARE_SUMMARY_20260202_123812.md
